...
Item {
    ...
    Item {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                anchors.fill: parent
                // The close button keeps the trailing edge of the pill.
                anchors.rightMargin: 30
                ...
                onClicked: {
                    const point = enginePill.mapToItem(root, 0, enginePill.height + 4);
                    engineMenu.x = Math.max(8, Math.min(root.width - engineMenu.width - 8, point.x));
                    engineMenu.y = point.y;
                    engineMenu.open();
                }
                StyledToolTip {
                    extraVisibleCondition: engineButton.containsMouse && engineButton.enabled
        ...
        StyledMenu {
            ...
            Repeater {
                model: SpotlightSearchService.searchEngines
                ...
                StyledMenuItem {
                    ...
                    checkable: true
                    checked: modelData.id === UiPreferences.spotlightSearchEngine
                    onTriggered: UiPreferences.setSpotlightSearchEngine(modelData.id)
                }
            }
        }
    ...
    Repeater {
        ...
        delegate: Item {
            ...
            readonly property bool activeMode: (index === 0 && root.mode === "web") || (index === 1
                                                                                        && root.mode
                                                                                        === "wallpapers") || (
