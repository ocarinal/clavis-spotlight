...
QtObject {
    ...
    readonly property color glassBorderColor: Qt.rgba(1, 1, 1, Appearance.m3colors.darkmode ? 0.20 : 0.34)
    readonly property color glassTopHighlightColor: Qt.rgba(1, 1, 1, Appearance.m3colors.darkmode ? 0.12 :
                                                                                                    0.24)
    readonly property color glassBottomShadeColor: Qt.rgba(0, 0, 0, Appearance.m3colors.darkmode ? 0.10 :
                                                                                                   0.045)
    readonly property color appGridTileBorderColor: Qt.rgba(1, 1, 1, Appearance.m3colors.darkmode ? 0.16 :
                                                                                                    0.28)
    ...
    readonly property real appGridHoverScale: 1.11
    ...
    readonly property int panelRevealDuration: 440
    readonly property int panelHideDuration: 160
